    ...
    public partial class Property : System.Web.UI.MasterPage
    {
        ...
        private void BindMenusList()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                StrMenu.Append("<li><a href=#>Residential & Commercial</a>");//</li>

                StrMenu.Append("<ul >");
                StrMenu.Append("<li><a href='http://www.iciworld.com/result?ft=ntce&memb.memberid_eq=kiran@khairarealty.com' title=''>My Haves and Wants</a></li>");
                StrMenu.Append("<li><a href='http://www.iciworld.com/lp4m.jsp?mid=10827&pg=searchAppWOres'>Residential Haves and Wants, Mostly Exclusive</a></li>");
                StrMenu.Append("<li><a href='http://www.iciworld.com/lp4m.jsp?mid=10827&pg=citiesONactive'>Ontario Commercial, Mostly Exclusive </a></li>");
                StrMenu.Append("<li><a href='http://www.iciworld.com/lp4m.jsp?mid=10827&pg=indexworld'> World Commercial</ a></li>");
                StrMenu.Append("<li><a href='http://www.iciworld.com/lp4m.jsp?mid=10827&pg=businessforsaleactive'>Business Haves and Wants </a></li>");
                StrMenu.Append("<li><a href='http://www.iciworld.com/xsearch?ft=fCat'>For Sale by Owner </a></li>");
                StrMenu.Append("</ul>");
